...
<html lang="fr-FR">
    ...
    <body>
        ...
        <section id="carte">
            ...
            <img src="https://open.mapquestapi.com/staticmap/v5/map?key=RQPHApk8GlvOS8GrpITYQAmuHY3Qdiin&locations=Manosque,Var,France|http://gil83.fr/nolark/marqueur_nolark.png
                      &center=Châteauroux,Indre,France&zoom=6&size=600,610" alt="Carte OpenStreetMap statique France">
            <img src="https://open.mapquestapi.com/staticmap/v5/map?key=RQPHApk8GlvOS8GrpITYQAmuHY3Qdiin
                      &locations=Boulevard de la Démocratie, Var, Provence-Alpes-Côte d'Azur, France métropolitaine, 83041, France
                      |http://gil83.fr/nolark/marqueur_nolark.png&zoom=13&size=306,300"
                      alt="Carte OpenStreetMap statique Toulon">
            <img src="https://open.mapquestapi.com/staticmap/v5/map?key=RQPHApk8GlvOS8GrpITYQAmuHY3Qdiin&locations=43.12115, 5.94037
                      |http://gil83.fr/nolark/marqueur_nolark.png&zoom=18&size=306,300" alt="Carte OpenStreetMap statique Nolark">
        </section>
